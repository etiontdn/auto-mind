    ...
    return (
        <div className="mx-auto mt-10 w-full max-w-xl animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <div className="relative group">
                ...
                <form onSubmit={handleSubmit} className="relative flex flex-col sm:flex-row items-center gap-3 p-2 bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-lg">
